...
function craeteCar(manufacturer:any,model:any, optioan:any ){
   let car ={
   manufacturer,
   model,
...
const carInfo = craeteCar("Toyota","Carmy",{//<-- call the function with required information and additional details -->
   color:"blue",
   year:2023,
